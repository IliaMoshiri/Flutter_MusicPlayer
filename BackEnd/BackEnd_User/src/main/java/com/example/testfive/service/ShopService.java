...
public class ShopService {
    ...
    @Transactional
    public CommentResponse addComment(String songId, Long userId, String text) {
    ...
    @Transactional
    public CommentResponse voteComment(Long commentId, Long userId, CommentVote.VoteType type){
        ...
        long likes = commentVoteRepo.countByCommentIdAndType(commentId, CommentVote.VoteType.LIKE);
        long dislikes = commentVoteRepo.countByCommentIdAndType(commentId, CommentVote.VoteType.DISLIKE);
